...
class PacketForwarder : public cSimpleModule, public cListener
{
  ...
  public:
      ...
      cPacketQueue highPriorityQueue;
      cPacketQueue lowPriorityQueue;
      cMessage *serviceTimer;
      bool isBusy;
      simsignal_t highQueueLengthSignal;
      simsignal_t lowQueueLengthSignal; // to check performance metrics.
};
} //namespace inet
#endif
